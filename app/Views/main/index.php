...
<form action="hotel/create" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
    <div class="-mx-3 md:flex mb-2">
        ...
        <div class="md:w-full px-3">
            ...
            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" name="floor_hotel" id="floor-hotel" type="number" required>
        </div>
